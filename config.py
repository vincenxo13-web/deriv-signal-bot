...
def get_settings() -> Settings:
    ...
    if _SETTINGS_INSTANCE is None:
        ...
        _SETTINGS_INSTANCE = Settings(
            ...
            min_risk_reward=max(0.1, _float_env("MIN_RISK_REWARD", 1.0)),
            trend_following_spike_mode=_bool_env("TREND_FOLLOWING_SPIKE_MODE", True),
            require_trend_alignment=_bool_env("REQUIRE_TREND_ALIGNMENT", False),
            ...
            require_stoch_for_trigger=_bool_env("REQUIRE_STOCH_FOR_TRIGGER", False),
            ...
            score_cap_high_volatility=_float_env("SCORE_CAP_HIGH_VOLATILITY", 86.0),
            score_cap_no_hard_confirmation=_float_env("SCORE_CAP_NO_HARD_CONFIRMATION", 78.0),
